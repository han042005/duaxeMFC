...
Duongdua::Duongdua() : Hcn(), totalScrollDistance(0), scrolledDistance(0), laneLineOffset(0), elapsedTime(0) {}

Duongdua::Duongdua(int x1, int y1, int x2, int y2)
    : Hcn(x1, y1, x2, y2), totalScrollDistance(5 * 60 * 50 * 3), scrolledDistance(0), laneLineOffset(0), elapsedTime(0) {
}
